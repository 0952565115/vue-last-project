<template>
  ...
  <div class="navmenu" style="max-width:100%;">
    <h1 class="headname">โรคและการรักษา</h1> <br>
  </div>

<div class="album py-0 bg-body-tertiary" style="margin-top: -3rem;">        
  <div class="container" style="padding: 2rem;">
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
      <div class="col" style="padding: 1rem;" v-for="(i,index) in HealthDetails_1_list" :key="index">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <router-link :to="`/health/healthlist/healthdetails_1/${i.id}`">
...
import { ref } from 'vue';
import { useHealthDetails_1_list } from '@/stores/counter';

const healthdetails_1_all = useHealthDetails_1_list();
const HealthDetails_1_list = ref(healthdetails_1_all.HealthDetails_1_list);
