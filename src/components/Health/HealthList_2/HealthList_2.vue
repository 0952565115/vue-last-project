<template>
  ...
  <div class="navmenu" style="max-width:100%;">
    <h1 class="headname">โรคที่มักพบบ่อย</h1> <br>
  </div>
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <router-link :to="`/health/healthlist/healthdetails_2/${i.id}`">
...
import { ref } from 'vue';
import { useHealthDetails_2_list } from '../../../stores/counter';

const healthdetails_2_all = useHealthDetails_2_list();
const HealthDetails_2_list = ref(healthdetails_2_all.HealthDetails_2_list);
