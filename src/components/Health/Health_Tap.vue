        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <router-link :to="`/health/healthlist/${i.id}`">
...
import { ref } from 'vue';
import { useHealth_list } from '../../stores/counter';

const health_all = useHealth_list();
const Health_list = ref(health_all.Health_list);
