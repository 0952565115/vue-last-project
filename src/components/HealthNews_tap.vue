...
<div class="album py-0 bg-body-tertiary" style="margin-top: -3rem;">        
  <div class="container" style="padding: 2rem;">
    <div class="row row-cols-1 row-cols-sm-2 g-3">
      <div class="col" style="padding: 1rem;" v-for="(i,index) in HealthNews_list" :key="index">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <router-link :to="`/newsdetails/${i.id}`">
...
import { useHealthNews_list } from '../stores/counter';

const healthnews_all = useHealthNews_list();
const HealthNews_list = ref(healthnews_all.HealthNews_list);
