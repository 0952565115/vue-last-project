...
<div class="album py-0 bg-body-tertiary" style="margin-top: -3rem;">        
  <div class="container" style="padding: 2rem;">
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
      <div class="col" style="padding: 1rem;" v-for="(i,index) in HealthTips_list" :key="index">
        <div class="card shadow-sm">
          <div class="all-img">
            <img :src="i.coverimage" :alt="name" style="width:100%; height: 235px; border-radius: 15px;">
          </div>
          <div class="card-body">
            <p class="card-text">{{ i.name }}</p>
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <router-link :to="`/healthtips/healthtipslist/${i.id}`">
...
import { ref } from 'vue';
import { useHealthTips_list } from '../../stores/counter';

const healthTips_all = useHealthTips_list();
const HealthTips_list = ref(healthTips_all.HealthTips_list);
